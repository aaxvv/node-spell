...
public abstract class FlowNode extends Node {
    ...
    public FlowNode(NodeCategory category, ResourceLocation resourceLocation) {
        super(category, resourceLocation);
    }

    public FlowNode(String translationKey, NodeCategory category, ResourceLocation resourceLocation) {
