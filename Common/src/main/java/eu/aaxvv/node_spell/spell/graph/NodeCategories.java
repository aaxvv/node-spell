...
public class NodeCategories {
    ...
    public static final NodeCategory LIST = new NodeCategory(ModConstants.resLoc("list"), 400, ModConstants.Colors.LIGHT_BLUE);

    public static final NodeCategory MATH = new NodeCategory(ModConstants.resLoc("math"), 500, ModConstants.Colors.LIGHT_BLUE);
    public static final NodeCategory VECTOR = new NodeCategory(ModConstants.resLoc("vector"), 600, ModConstants.Colors.LIGHT_BLUE);
    public static final NodeCategory COMPARISON = new NodeCategory(ModConstants.resLoc("comparison"), 700, ModConstants.Colors.LIGHT_BLUE);
    public static final NodeCategory LOGIC = new NodeCategory(ModConstants.resLoc("logic"), 800, ModConstants.Colors.LIGHT_BLUE);
    public static final NodeCategory STRING = new NodeCategory(ModConstants.resLoc("string"), 900, ModConstants.Colors.LIGHT_BLUE);

    public static final NodeCategory ENTITY = new NodeCategory(ModConstants.resLoc("entity"), 1000, ModConstants.Colors.LIGHT_BLUE);
    public static final NodeCategory BLOCK = new NodeCategory(ModConstants.resLoc("block"), 1200, ModConstants.Colors.LIGHT_BLUE);
    public static final NodeCategory ITEM = new NodeCategory(ModConstants.resLoc("item"), 1300, ModConstants.Colors.LIGHT_BLUE);
