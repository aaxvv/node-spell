...
public class NodeCategories {
    ...
    public static final NodeCategory LOGIC = new NodeCategory(ModConstants.resLoc("logic"), 300, 0xFF3EA84F);
    public static final NodeCategory COMPARISON = new NodeCategory(ModConstants.resLoc("comparison"), 400, 0xFF3EA84F);
    public static final NodeCategory MATH = new NodeCategory(ModConstants.resLoc("math"), 500, 0xFF3B94A5);
